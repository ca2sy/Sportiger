...
export function Produtos() {
  return (
    ...
    >
      ...
      <p className="mb-1 max-w-[70rem] text-lg font-light text-white sm:text-xl md:text-2xl">
      ...
      <div className="mt-12 w-full max-w-[1300px]">
        <div className="relative flex h-auto min-h-[600px] w-full flex-col rounded-[20px] border border-[#FFB86A] bg-black/25 px-6 py-10 text-left lg:flex-row lg:px-12 lg:py-0">
          ...
          <div className="order-2 w-full space-y-6 text-white lg:order-1 lg:mt-32 lg:w-1/2">
            <p className="font-inter text-2xl leading-relaxed font-semibold whitespace-nowrap">
              Qualidade de verdade para quem vive o esporte.
            </p>

            <p className="font-inter text-2xl leading-relaxed font-medium lg:w-11/12">

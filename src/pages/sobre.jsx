...
export function Sobre() {
  return (
    <div className="mt-20 relative z-30 flex flex-col items-center justify-center rounded-[50px] bg-[#101820]/40 px-4 pt-30 text-center backdrop-blur-md sm:px-6 lg:px-10">
